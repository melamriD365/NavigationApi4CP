...
export class ErrorDialog implements ComponentFramework.StandardControl<IInputs, IOutputs> {
        ...
        switch (this._displayState) {
            ...
            case "open":
                ...
                let ErrorDialogOptions = {
                    details: this._context.parameters.details.raw!,
                    errorCode: this._context.parameters.errorCode.raw!,
                    message: this._context.parameters.message.raw!
                }
                
                this._context.navigation.openErrorDialog(ErrorDialogOptions).then(
                    function success() {
