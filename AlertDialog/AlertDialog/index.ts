...
export class AlertDialog implements ComponentFramework.StandardControl<IInputs, IOutputs> {
    ...
    public updateView(context: ComponentFramework.Context<IInputs>): void {
        ...
        switch (this._displayState) {
            ...
            case "open":
                ...
                this._context.navigation.openAlertDialog(alertStrings, options).then(
                    function success() {
